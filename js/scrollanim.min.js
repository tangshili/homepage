/*! kissui.scrollanim 2016-08-07 */ ! function(a, b) {
	...
	function f(a, b) {
		...
		c.indexOf("in") > -1 && (d = e >= 0 && g >= 0 && f <= l && h <= m && (d && !0)), c.indexOf("out") > -1 && (d = (e + j < 0 || g + k < 0 || g > m || e > l) && (d && !0)), c.indexOf("top") > -1 && (d = 0 == e && (d && !0)), c.indexOf("left") > -1 && (d = 0 == g && (d && !0)), c.indexOf("right") > -1 && (d = h == m && (d && !0)), c.indexOf("bottom") > -1 && (d = f == l && (d && !0)), c.indexOf("middle") > -1 && (d = e + j / 2 == l / 2 && (d && !0)), c.indexOf("center") > -1 && (d = g + k / 2 == m / 2 && (d && !0)), d && (a.getAttribute("id") && i(a.getAttribute("id"), a), i(b, a), i("*", a, b))
	}
	...
	return n.events = ["in", "out", "middle", "top", "bottom", "left", "center", "right"], _removeListener = function(a, b) {
		var c;
...
function(a, b) {
	...
	function e(a, b) {
		for(var c in a.event) c == b && a.event[c].active === !1 && (a.element.style.opacity = "1", a.element.className += " animated " + a.event[c].animation, function(a, b) {
			f(a.element, ["webkitAnimationEnd", "mozAnimationEnd", "MSAnimationEnd", "oanimationend", "animationend"], function() {
				a.element.className = a.element.className.replace("animated " + a.event[b].animation, ""), a.event[b].active = !0
			})
		}(a, c))
	}
